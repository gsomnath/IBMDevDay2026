...
public class AdminController {
    ...
    @PreAuthorize("@securityService.hasAccessToResource(#resourceId, authentication)")
...
| Item | Status | Notes |
|------|--------|-------|
| CSRF Protection | Disabled for stateless | Use for session-based |
| CORS | Configured | Whitelist origins |
| Password Encoding | BCrypt | Never store plain text |
| JWT Expiration | 24 hours | Use refresh tokens |
| Rate Limiting | Recommended | Use bucket4j or similar |
| Input Validation | Required | Validate all inputs |
